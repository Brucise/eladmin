...
INSERT INTO `sys_dept` (`dept_id`, `pid`, `sub_count`, `name`, `dept_sort`, `enabled`, `create_by`, `update_by`,
                        `create_time`, `update_time`)
VALUES (18, NULL, 0, '客户组', 999, b'1', 'admin', 'admin', '2020-08-02 14:49:07', '2020-08-02 14:49:07');
COMMIT;
...
INSERT INTO `sys_role` (`role_id`, `name`, `level`, `description`, `data_scope`, `create_by`, `update_by`,
                        `create_time`, `update_time`)
VALUES (3, '客户', 2, '-', '本级', NULL, 'admin', '2018-11-23 13:09:06', '2020-09-05 10:45:12');
COMMIT;
...
(
    ...
    request_data  TEXT        NOT NULL COMMENT '支付网关请求数据',
    response_data TEXT COMMENT '支付网关响应数据',
    status        VARCHAR(32) NOT NULL COMMENT '交易状态 (PENDING, SUCCESS, FAILED, CANCELLED)',
    created_at    TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '交易创建时间',
    updated_at    TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '交易更新时间',

    -- 添加索引，优化查询
    INDEX         idx_payment_id (payment_id),
    INDEX         idx_status (status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='支付交易表';
